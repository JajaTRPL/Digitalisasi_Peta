    ...
    <div class="modal-body">
        <form id="tambahAdminForm" class="space-y-4">
            ...
            <div class="relative">
                ...
                <input type="password" id="password" name="password" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 pr-10" required>
                <button type="button" class="absolute right-3 bottom-2 text-gray-500 hover:text-gray-700" onclick="togglePasswordVisibility('password', this)">
                    <i class="fas fa-eye"></i>
                </button>
            </div>
            <div class="relative">
                <label for="confirmPassword" class="block text-sm font-medium text-gray-700">Konfirmasi Password</label>
                <input type="password" id="confirmPassword" name="confirmPassword" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 pr-10" required>
                <button type="button" class="absolute right-3 bottom-2 text-gray-500 hover:text-gray-700" onclick="togglePasswordVisibility('confirmPassword', this)">
                    <i class="fas fa-eye"></i>
                </button>
            </div>
