    ...
    <div class="modal-body">
        <form id="editAdminForm" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="password" id="editPassword" name="password" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 pr-10">
                    <button type="button" class="absolute inset-y-0 right-0 pr-3 flex items-center" onclick="togglePasswordVisibility('editPassword')">
