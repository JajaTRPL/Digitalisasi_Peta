    ...
    <script>
        ...
        function showToast(message, type = 'success') {
            const bgColor = type === 'error'
                ? "linear-gradient(to right, #ff5f6d, #ffc371)"  // Merah ke oranye
                : "linear-gradient(to right, #00b09b, #96c93d)"; // Hijau
        ...
        $(document).ready(function () {
                ...
                success: function (response) {
                    ...
                    if (data.coordinates) {
                        try {
                            ...
                            showToast('Gagal memuat data polygon', 'error');
                        }
                    }
                },
                error: function () {
                    showToast('Gagal memuat data tanah', 'error');
                }
            });
            ...
            $('#perbarui').on('click', function (e) {
                ...
                formData.append('coordinates', $('#polygon').val());
                ...
                $.ajax({
                    ...
                    error: function (err) {
                        console.error(err);
                        let errorMessage = 'Terjadi kesalahan. Cek console untuk detail.';
